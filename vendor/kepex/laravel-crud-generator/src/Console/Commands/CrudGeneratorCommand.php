...
class CrudGeneratorCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:crud {model-name} {--force} {--singular} {--table-name=} {--master-layout=} {--custom-controller=} {--folder=}';
    ...
    public function handle()
    {
        ...
        $folderModule = $this->option('folder');
        ...
        foreach ($tocreate as $c) {
            ...
            $generator->folderModule = $folderModule;
