    ...
    <form action="{{ url('/examples'.( isset($example) ? "/" . $example->id : "")) }}" method="POST" class="form-horizontal form-process" id="form" >
        ...
        {!! (!empty( $arrShowFieldFrom['users_id'] ))?       
            '<div class="form-group">'.               
                ...
                .'<div class="col-sm-6">'.
                    Form::select('users_id',['' => '']+$User, @$example['users_id'] , array('placeholder'=>__("example.placeholder_users_id"),'class' => 'select2_single form-control','required','','data-parsley-errors-container'=>'#errors-messages-box-users_id' , 'data-parsley-error-message' =>  __("validation.required", ['attribute' => __("example.label_users_id")]) ))
        ...
        {!! (!empty( $arrShowFieldFrom['body'] ))?
            '<div class="form-group">'.
                ...
                .'<div class="col-sm-6">'.               
                Form::textarea('body', @$example['body'], array('placeholder'=>__("example.placeholder_body"),'class' => 'form-control text-editor','required','', 'data-parsley-error-message' =>  __("validation.required", ['attribute' => __("example.label_body")]) ))
                .'</div>
            </div>'
        : '' !!}
