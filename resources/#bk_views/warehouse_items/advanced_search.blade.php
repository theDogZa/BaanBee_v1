...
<div class="row">
        ...
        {!! (!empty( $arrShowField['warehouse_id'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.       
                Form::label('warehouse_id', __('warehouse_item.th_warehouse_id'), array('class' => 'control-label'))
                .'<div>'.
        ...
        {!! (!empty( $arrShowField['item_id'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.       
                Form::label('item_id', __('warehouse_item.th_item_id'), array('class' => 'control-label'))
                .'<div>'.
        ...
        {!! (!empty( $arrShowField['qty'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">
                <div class="row">'.
                        Form::label('qty', __('warehouse_item.th_qty'), array('class' => 'control-label col-xs-12'))
                .'</div>
        ...
        {!! (!empty( $arrShowField['min_qty'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">
                <div class="row">'.
                        Form::label('min_qty', __('warehouse_item.th_min_qty'), array('class' => 'control-label col-xs-12'))
                .'</div>
                <div class="col-xs-12 search-number" >
                    <div class="input-group">'.
        ...
        {!! (!empty( $arrShowField['max_qty'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">
                <div class="row">'.
                        Form::label('max_qty', __('warehouse_item.th_max_qty'), array('class' => 'control-label col-xs-12'))
                .'</div>
                <div class="col-xs-12 search-number" >
                    <div class="input-group">'.
        ...
        {!! (!empty( $arrShowField['warehouse_item_desc'] ))?
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('warehouse_item_desc', __('warehouse_item.th_warehouse_item_desc'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['active'] ))?
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('active', __('warehouse_item.th_active'), array('class' => 'control-label'))
                .'<div>'.
