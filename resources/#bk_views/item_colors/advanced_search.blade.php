...
<div class="row">
        ...
        {!! (!empty( $arrShowField['color_name'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('color_name', __('item_color.th_color_name'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['color_code'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('color_code', __('item_color.th_color_code'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['color_desc'] ))?
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('color_desc', __('item_color.th_color_desc'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['active'] ))?
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('active', __('item_color.th_active'), array('class' => 'control-label'))
                .'<div>'.
