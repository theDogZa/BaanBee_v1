...
<div class="row">
        ...
        {!! (!empty( $arrShowField['type_name'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('type_name', __('item_type.th_type_name'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['type_code'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('type_code', __('item_type.th_type_code'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['type_desc'] ))?
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('type_desc', __('item_type.th_type_desc'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['active'] ))?
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('active', __('item_type.th_active'), array('class' => 'control-label'))
                .'<div>'.
