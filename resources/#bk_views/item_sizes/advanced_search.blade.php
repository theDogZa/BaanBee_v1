...
<div class="row">
        ...
        {!! (!empty( $arrShowField['size_name'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('size_name', __('item_size.th_size_name'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['size_code'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('size_code', __('item_size.th_size_code'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['size_desc'] ))?
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('size_desc', __('item_size.th_size_desc'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['active'] ))?
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('active', __('item_size.th_active'), array('class' => 'control-label'))
                .'<div>'.
