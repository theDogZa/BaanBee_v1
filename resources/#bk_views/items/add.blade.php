...
@endif 
    ...
    <div class="x_content">
        ...
        @endif
                <form action="{{ url('/items'.( isset($item) ? " / " . $item->id : " ")) }}" method="POST" class="form-horizontal form-process"
                    id="form">
                    {{ csrf_field() }} @if(isset($item)) {{ Form::hidden('_method','PATCH') }} @endif {!! (!empty( $arrShowFieldFrom['item_categorie_id']
                    ))? '
                    <div class="form-group">'. Form::label('item_categorie_id', __("item.label_item_categorie_id").' *', array('class' => 'col-sm-3 control-label'))
                        .'
                        <div class="col-sm-6">'. Form::select('item_categorie_id',['' => '']+$Item_category, @$item['item_categorie_id'] , array('placeholder'=>__("item.placeholder_item_categorie_id"),'class'
                    ...
                    <div class="form-group">'. Form::label('item_size_id', __("item.label_item_size_id").' *', array('class' => 'col-sm-3 control-label')) .'
                        <div class="col-sm-6">'. Form::select('item_size_id',['' => '']+$Item_size, @$item['item_size_id'] , array('placeholder'=>__("item.placeholder_item_size_id"),'class'
                    ...
                    <div class="form-group">'. Form::label('item_color_id', __("item.label_item_color_id").' *', array('class' => 'col-sm-3 control-label')) .'
                        <div class="col-sm-6">'. Form::select('item_color_id',['' => '']+$Item_color, @$item['item_color_id'] , array('placeholder'=>__("item.placeholder_item_color_id"),'class'
                    ...
                    <div class="form-group">'. Form::label('item_unit_id', __("item.label_item_unit_id").' *', array('class' => 'col-sm-3 control-label')) .'
                        <div class="col-sm-6">'. Form::select('item_unit_id',['' => '']+$Item_unit, isset($item)? @$item['item_unit_id'] : 1, array('placeholder'=>__("item.placeholder_item_unit_id"),'class'
                    ...
                    <div class="form-group">'. Form::label('item_name', __("item.label_item_name").' *', array('class' => 'col-sm-3 control-label')) .'
                        <div class="col-sm-6">'. Form::text('item_name', @$item['item_name'], array('placeholder'=>__("item.placeholder_item_name"),'class' =>
                    ...
                    <div class="form-group">'. Form::label('item_code', __("item.label_item_code").' *', array('class' => 'col-sm-3 control-label')) .'
                        <div class="col-sm-6">'. Form::text('item_code', @$item['item_code'], array('placeholder'=>__("item.placeholder_item_code"),'class' =>
                    ...
                    <div class="form-group">'. Form::label('item_num', __("item.label_item_num").' *', array('class' => 'col-sm-3 control-label')) .'
                        <div class="col-sm-6">'. Form::text('item_num', @$item['item_num'], array('placeholder'=>__("item.placeholder_item_num"),'class' => 'form-control','id'
                    ...
                    <div class="form-group">'. Form::label('item_sale_price', __("item.label_item_sale_price").' *', array('class' => 'col-sm-3 control-label'))
                        .'
                        <div class="col-sm-6">'. Form::number('item_sale_price',@$item['item_sale_price'], array('placeholder'=>__("item.placeholder_item_sale_price"),'class'
                    ...
                    <div class="form-group">'. Form::label('item_cost_price', __("item.label_item_cost_price").' ', array('class' => 'col-sm-3 control-label')) .'
                        <div class="col-sm-6">'. Form::number('item_cost_price',@$item['item_cost_price'], array('placeholder'=>__("item.placeholder_item_cost_price"),'class'
                    ...
                    <div class="form-group">'. Form::label('item_qty', __("item.label_item_qty").' ', array('class' => 'col-sm-3 control-label')) .'
                        <div class="col-sm-6">'. Form::number('item_qty',@$item['item_qty'], array('placeholder'=>__("item.placeholder_item_qty"),'class' => 'form-control',
                    ...
                    <div class="form-group">'. Form::label('item_qty_min', __("item.label_item_qty_min").' ', array('class' => 'col-sm-3 control-label')) .'
                        <div class="col-sm-6">'. Form::number('item_qty_min',@$item['item_qty_min'], array('placeholder'=>__("item.placeholder_item_qty_min"),'class'
                    ...
                    <div class="form-group">'. Form::label('item_qty_max', __("item.label_item_qty_max").' ', array('class' => 'col-sm-3 control-label')) .'
                        <div class="col-sm-6">'. Form::number('item_qty_max',@$item['item_qty_max'], array('placeholder'=>__("item.placeholder_item_qty_max"),'class'
                    ...
                    <div class="form-group">'. Form::label('item_sale_qty', __("item.label_item_sale_qty").' ', array('class' => 'col-sm-3 control-label')) .'
                        <div class="col-sm-6">'. Form::number('item_sale_qty',@$item['item_sale_qty'], array('placeholder'=>__("item.placeholder_item_sale_qty"),'class'
                    ...
                    <div class="form-group">'. Form::label('item_desc', __("item.label_item_desc").' ', array('class' => 'col-sm-3 control-label')) .'
                        <div class="col-sm-6">'. Form::textarea('item_desc', @$item['item_desc'], array('placeholder'=>__("item.placeholder_item_desc"),'class'
                    ...
                    <div class="form-group">'. Form::label('active', __("item.label_active").' ', array('class' => 'col-sm-3 control-label')) .'
                        <div class="col-sm-6">'. _createRadio('active',@$item['active']) .'
                        </div>
                    </div>' : '' !!}
