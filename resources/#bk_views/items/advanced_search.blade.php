...
<div class="row">
        ...
        {!! (!empty( $arrShowField['item_categorie_id'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.       
                Form::label('item_categorie_id', __('item.th_item_categorie_id'), array('class' => 'control-label'))
                .'<div>'.
        ...
        {!! (!empty( $arrShowField['item_size_id'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.       
                Form::label('item_size_id', __('item.th_item_size_id'), array('class' => 'control-label'))
                .'<div>'.
        ...
        {!! (!empty( $arrShowField['item_color_id'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.       
                Form::label('item_color_id', __('item.th_item_color_id'), array('class' => 'control-label'))
                .'<div>'.
        ...
        {!! (!empty( $arrShowField['item_unit_id'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.       
                Form::label('item_unit_id', __('item.th_item_unit_id'), array('class' => 'control-label'))
                .'<div>'.
        ...
        {!! (!empty( $arrShowField['item_name'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('item_name', __('item.th_item_name'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['item_code'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('item_code', __('item.th_item_code'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['item_num'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('item_num', __('item.th_item_num'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['item_sale_price'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">
                <div class="row">'.
                        Form::label('item_sale_price', __('item.th_item_sale_price'), array('class' => 'control-label col-xs-12'))
                .'</div>
        ...
        {!! (!empty( $arrShowField['item_cost_price'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">
                <div class="row">'.
                        Form::label('item_cost_price', __('item.th_item_cost_price'), array('class' => 'control-label col-xs-12'))
                .'</div>
                <div class="col-xs-12 search-number" >
                    <div class="input-group">'.
        ...
        {!! (!empty( $arrShowField['item_qty'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">
                <div class="row">'.
                        Form::label('item_qty', __('item.th_item_qty'), array('class' => 'control-label col-xs-12'))
                .'</div>
                <div class="col-xs-12 search-number" >
                    <div class="input-group">'.
        ...
        {!! (!empty( $arrShowField['item_qty_min'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">
                <div class="row">'.
                        Form::label('item_qty_min', __('item.th_item_qty_min'), array('class' => 'control-label col-xs-12'))
                .'</div>
                <div class="col-xs-12 search-number" >
                    <div class="input-group">'.
        ...
        {!! (!empty( $arrShowField['item_qty_max'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">
                <div class="row">'.
                        Form::label('item_qty_max', __('item.th_item_qty_max'), array('class' => 'control-label col-xs-12'))
                .'</div>
                <div class="col-xs-12 search-number" >
                    <div class="input-group">'.
        ...
        {!! (!empty( $arrShowField['item_sale_qty'] ))?       
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">
                <div class="row">'.
                        Form::label('item_sale_qty', __('item.th_item_sale_qty'), array('class' => 'control-label col-xs-12'))
                .'</div>
                <div class="col-xs-12 search-number" >
                    <div class="input-group">'.
        ...
        {!! (!empty( $arrShowField['item_desc'] ))?
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('item_desc', __('item.th_item_desc'), array('class' => 'control-label'))
        ...
        {!! (!empty( $arrShowField['active'] ))?
            '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 form-group">'.
                Form::label('active', __('item.th_active'), array('class' => 'control-label'))
                .'<div>'.
