    ...
    <form action="{{ url('/users'.( isset($user) ? "/" . $user->id : "")) }}" method="POST" class="form-horizontal form-process" id="form" >
        ...
        {!! (!empty( $arrShowFieldFrom['name'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('name', __("user.label_name").' *', array('class' => config("core.layout.form.add.label")))
        ...
        {!! (!empty( $arrShowFieldFrom['username'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('username', __("user.label_username").' *', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['email'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('email', __("user.label_email").' *', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['password'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('password', __("user.label_password"), array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['password'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('password', __("user.label_confirm_password") , array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['remember_token'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('remember_token', __("user.label_remember_token").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['online'] ))?     
            '<div class="'.config('core.layout.form.add.box').'">'.
                 Form::label('online', __("user.label_online").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.              
        ...
        {!! (!empty( $arrShowFieldFrom['active'] ))?
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('active', __("user.label_active"), array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.             
