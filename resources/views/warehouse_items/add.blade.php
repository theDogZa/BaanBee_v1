    ...
    <form action="{{ url('/warehouse_items'.( isset($warehouse_item) ? "/" . $warehouse_item->id : "")) }}" method="POST" class="form-horizontal form-process" id="form" >
        ...
        {!! (!empty( $arrShowFieldFrom['warehouse_id'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.               
                Form::label('warehouse_id', __("warehouse_item.label_warehouse_id").' *', array('class' => config("core.layout.form.add.label")))
        ...
        {!! (!empty( $arrShowFieldFrom['item_id'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.               
                Form::label('item_id', __("warehouse_item.label_item_id").' *', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['qty'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('qty', __("warehouse_item.label_qty").' *', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['min_qty'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('min_qty', __("warehouse_item.label_min_qty").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['max_qty'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('max_qty', __("warehouse_item.label_max_qty").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['warehouse_item_desc'] ))?
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('warehouse_item_desc', __("warehouse_item.label_warehouse_item_desc").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.               
                Form::textarea('warehouse_item_desc', @$warehouse_item['warehouse_item_desc'], array('rows'=> config("core.layout.input.textarea.rows"),'placeholder'=>__("warehouse_item.placeholder_warehouse_item_desc"),'class' => 'form-control text-editor','','', 'data-parsley-error-message' =>  __("validation.required", ['attribute' => __("warehouse_item.label_warehouse_item_desc")]) ))
                .'</div>
            </div>'
        : '' !!}
        ...
        {!! (!empty( $arrShowFieldFrom['active'] ))?
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('active', __("warehouse_item.label_active").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.             
