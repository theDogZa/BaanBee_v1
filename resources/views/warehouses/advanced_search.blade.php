    ...
    <div class="row">
        {!! (!empty( $arrShowField['warehouse_name'] ))?       
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('warehouse_name', __('warehouse.th_warehouse_name'), array('class' => config("core.layout.form.search.label")))
        ...
        {!! (!empty( $arrShowField['warehouse_code'] ))?       
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('warehouse_code', __('warehouse.th_warehouse_code'), array('class' => config("core.layout.form.search.label")))
                .'<div class="'.config('core.layout.form.search.input').'">'.
        ...
        {!! (!empty( $arrShowField['province_id'] ))?       
            '<div class="'.config('core.layout.form.search.box').'">'.       
                Form::label('province_id', __('warehouse.th_province_id'), array('class' => config("core.layout.form.search.label")))
                .'<div class="'.config('core.layout.form.search.input').'">'.
        ...
        {!! (!empty( $arrShowField['warehouse_tel1'] ))?       
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('warehouse_tel1', __('warehouse.th_warehouse_tel1'), array('class' => config("core.layout.form.search.label")))
                .'<div class="'.config('core.layout.form.search.input').'">'.
        ...
        {!! (!empty( $arrShowField['warehouse_tel2'] ))?       
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('warehouse_tel2', __('warehouse.th_warehouse_tel2'), array('class' => config("core.layout.form.search.label")))
                .'<div class="'.config('core.layout.form.search.input').'">'.
        ...
        {!! (!empty( $arrShowField['warehouse_address'] ))?
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('warehouse_address', __('warehouse.th_warehouse_address'), array('class' => config("core.layout.form.search.label")))
                .'<div class="'.config('core.layout.form.search.input').'">'.
        ...
        {!! (!empty( $arrShowField['warehouse_desc'] ))?
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('warehouse_desc', __('warehouse.th_warehouse_desc'), array('class' => config("core.layout.form.search.label")))
                .'<div class="'.config('core.layout.form.search.input').'">'.
        ...
        {!! (!empty( $arrShowField['active'] ))?
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('active', __('warehouse.th_active'), array('class' => config("core.layout.form.search.label")))
                .'<div class="'.config('core.layout.form.search.input').'">'.
