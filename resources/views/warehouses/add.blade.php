    ...
    <form action="{{ url('/warehouses'.( isset($warehouse) ? "/" . $warehouse->id : "")) }}" method="POST" class="form-horizontal form-process" id="form" >
        ...
        {!! (!empty( $arrShowFieldFrom['warehouse_name'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('warehouse_name', __("warehouse.label_warehouse_name").' *', array('class' => config("core.layout.form.add.label")))
        ...
        {!! (!empty( $arrShowFieldFrom['warehouse_code'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('warehouse_code', __("warehouse.label_warehouse_code").' *', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        : '' !!} 
         ...
         {!! (!empty( $arrShowFieldFrom['warehouse_address'] ))?
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('warehouse_address', __("warehouse.label_warehouse_address").' *', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.               
                Form::textarea('warehouse_address', @$warehouse['warehouse_address'], array('rows'=> config("core.layout.input.textarea.rows"),'placeholder'=>__("warehouse.placeholder_warehouse_address"),'class' => 'form-control text-editor','required','', 'data-parsley-error-message' =>  __("validation.required", ['attribute' => __("warehouse.label_warehouse_address")]) ))
                .'</div>
            </div>'
        : '' !!}
        ...
        {!! (!empty( $arrShowFieldFrom['province_id'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.               
                Form::label('province_id', __("warehouse.label_province_id").' *', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['warehouse_tel1'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('warehouse_tel1', __("warehouse.label_warehouse_tel1").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['warehouse_tel2'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('warehouse_tel2', __("warehouse.label_warehouse_tel2").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['warehouse_desc'] ))?
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('warehouse_desc', __("warehouse.label_warehouse_desc").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.               
                Form::textarea('warehouse_desc', @$warehouse['warehouse_desc'], array('rows'=> config("core.layout.input.textarea.rows"),'placeholder'=>__("warehouse.placeholder_warehouse_desc"),'class' => 'form-control text-editor','','', 'data-parsley-error-message' =>  __("validation.required", ['attribute' => __("warehouse.label_warehouse_desc")]) ))
                .'</div>
            </div>'
        : '' !!}
        ...
        {!! (!empty( $arrShowFieldFrom['active'] ))?
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('active', __("warehouse.label_active").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.             
