    ...
    <div class="row">
        {!! (!empty( $arrShowField['unit_name'] ))?       
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('unit_name', __('item_unit.th_unit_name'), array('class' => config("core.layout.form.search.label")))
        ...
        {!! (!empty( $arrShowField['unit_desc'] ))?
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('unit_desc', __('item_unit.th_unit_desc'), array('class' => config("core.layout.form.search.label")))
                .'<div class="'.config('core.layout.form.search.input').'">'.
        ...
        {!! (!empty( $arrShowField['active'] ))?
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('active', __('item_unit.th_active'), array('class' => config("core.layout.form.search.label")))
                .'<div class="'.config('core.layout.form.search.input').'">'.
