    ...
    <form action="{{ url('/item_types'.( isset($item_type) ? "/" . $item_type->id : "")) }}" method="POST" class="form-horizontal form-process" id="form" >
        ...
        {!! (!empty( $arrShowFieldFrom['type_name'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('type_name', __("item_type.label_type_name").' *', array('class' => config("core.layout.form.add.label")))
        ...
        {!! (!empty( $arrShowFieldFrom['type_code'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('type_code', __("item_type.label_type_code").' *', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['type_desc'] ))?
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('type_desc', __("item_type.label_type_desc").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.               
                Form::textarea('type_desc', @$item_type['type_desc'], array('rows'=> config("core.layout.input.textarea.rows"),'placeholder'=>__("item_type.placeholder_type_desc"),'class' => 'form-control text-editor','','', 'data-parsley-error-message' =>  __("validation.required", ['attribute' => __("item_type.label_type_desc")]) ))
                .'</div>
            </div>'
        : '' !!}
        ...
        {!! (!empty( $arrShowFieldFrom['active'] ))?
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('active', __("item_type.label_active").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.             
