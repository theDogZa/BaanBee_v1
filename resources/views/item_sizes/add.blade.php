    ...
    <form action="{{ url('/item_sizes'.( isset($item_size) ? "/" . $item_size->id : "")) }}" method="POST" class="form-horizontal form-process" id="form" >
        ...
        {!! (!empty( $arrShowFieldFrom['size_name'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('size_name', __("item_size.label_size_name").' *', array('class' => config("core.layout.form.add.label")))
        ...
        {!! (!empty( $arrShowFieldFrom['size_code'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('size_code', __("item_size.label_size_code").' *', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['size_desc'] ))?
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('size_desc', __("item_size.label_size_desc").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.               
                Form::textarea('size_desc', @$item_size['size_desc'], array('rows'=> config("core.layout.input.textarea.rows"),'placeholder'=>__("item_size.placeholder_size_desc"),'class' => 'form-control text-editor','','', 'data-parsley-error-message' =>  __("validation.required", ['attribute' => __("item_size.label_size_desc")]) ))
                .'</div>
            </div>'
        : '' !!}
        ...
        {!! (!empty( $arrShowFieldFrom['active'] ))?
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('active', __("item_size.label_active").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.             
