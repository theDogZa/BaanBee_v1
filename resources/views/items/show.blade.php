            ...
            <ul id="ityemTab" class="nav nav-tabs bar_tabs" role="tablist">
                <li role="presentation" class="active">
                    <a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">
                        <h2>
                            {!! config('core.icon.title_view') !!} {{ ucfirst(__('item.head_view')) }}
                        </h2>
                    </a>
                </li>
            ...
            <form action="{{ url('/posts') }}" method="POST" class="form-horizontal">        
                ...
                {!! (!empty( $arrShowFieldView['item_categorie_id'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.              
                        Form::label('item_categorie_id', __("item.label_item_categorie_id"), array('class' => config("core.layout.form.view.label")))
                ...
                {!! (!empty( $arrShowFieldView['item_size_id'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.              
                        Form::label('item_size_id', __("item.label_item_size_id"), array('class' => config("core.layout.form.view.label")))
                        .'<div class="'.config('core.layout.form.view.input').'">'.
                ...
                {!! (!empty( $arrShowFieldView['item_color_id'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.              
                        Form::label('item_color_id', __("item.label_item_color_id"), array('class' => config("core.layout.form.view.label")))
                        .'<div class="'.config('core.layout.form.view.input').'">'.
                ...
                {!! (!empty( $arrShowFieldView['item_unit_id'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.              
                        Form::label('item_unit_id', __("item.label_item_unit_id"), array('class' => config("core.layout.form.view.label")))
                        .'<div class="'.config('core.layout.form.view.input').'">'.
                ...
                {!! (!empty( $arrShowFieldView['item_name'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.
                        Form::label('item_name', __("item.label_item_name"), array('class' => config("core.layout.form.view.label"))) 
                        .'<div class="'.config('core.layout.form.view.input').'">'.
                ...
                {!! (!empty( $arrShowFieldView['item_code'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.
                        Form::label('item_code', __("item.label_item_code"), array('class' => config("core.layout.form.view.label"))) 
                        .'<div class="'.config('core.layout.form.view.input').'">'.
                ...
                {!! (!empty( $arrShowFieldView['item_num'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.
                        Form::label('item_num', __("item.label_item_num"), array('class' => config("core.layout.form.view.label"))) 
                        .'<div class="'.config('core.layout.form.view.input').'">'.
                ...
                {!! (!empty( $arrShowFieldView['item_sale_price'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.
                        Form::label('item_sale_price', __("item.label_item_sale_price"), array('class' => config("core.layout.form.view.label"))) 
                        .'<div class="'.config('core.layout.form.view.input').'">'.
                ...
                {!! (!empty( $arrShowFieldView['item_cost_price'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.
                        Form::label('item_cost_price', __("item.label_item_cost_price"), array('class' => config("core.layout.form.view.label"))) 
                        .'<div class="'.config('core.layout.form.view.input').'">'.
                ...
                {!! (!empty( $arrShowFieldView['item_qty'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.
                        Form::label('item_qty', __("item.label_item_qty"), array('class' => config("core.layout.form.view.label"))) 
                        .'<div class="'.config('core.layout.form.view.input').'">'.
                ...
                {!! (!empty( $arrShowFieldView['item_qty_min'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.
                        Form::label('item_qty_min', __("item.label_item_qty_min"), array('class' => config("core.layout.form.view.label"))) 
                        .'<div class="'.config('core.layout.form.view.input').'">'.
                ...
                {!! (!empty( $arrShowFieldView['item_qty_max'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.
                        Form::label('item_qty_max', __("item.label_item_qty_max"), array('class' => config("core.layout.form.view.label"))) 
                        .'<div class="'.config('core.layout.form.view.input').'">'.
                ...
                {!! (!empty( $arrShowFieldView['item_sale_qty'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.
                        Form::label('item_sale_qty', __("item.label_item_sale_qty"), array('class' => config("core.layout.form.view.label"))) 
                        .'<div class="'.config('core.layout.form.view.input').'">'.
                ...
                {!! (!empty( $arrShowFieldView['item_desc'] ))?
                    '<div class="'.config('core.layout.form.view.button').'">'.
                        Form::label('item_desc', __("item.label_item_desc"), array('class' => config("core.layout.form.view.label")))
                    .'<div class="'.config('core.layout.form.view.input').'">'.              
                ...
                {!! (!empty( $arrShowFieldView['active'] ))?           
                    '<div class="'.config('core.layout.form.view.button').'">'.              
                        Form::label('active', __("item.label_active"), array('class' => config("core.layout.form.view.label")))
                        .'<div class="'.config('core.layout.form.view.input').'">'.
