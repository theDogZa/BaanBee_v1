    ...
    <form action="{{ url('/item_categories'.( isset($item_category) ? "/" . $item_category->id : "")) }}" method="POST" class="form-horizontal form-process" id="form" >
        ...
        {!! (!empty( $arrShowFieldFrom['item_type_id'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.               
                Form::label('item_type_id', __("item_category.label_item_type_id").' *', array('class' => config("core.layout.form.add.label")))
        ...
        {!! (!empty( $arrShowFieldFrom['categories_name'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('categories_name', __("item_category.label_categories_name").' *', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['categories_code'] ))?       
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('categories_code', __("item_category.label_categories_code").' *', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.
        ...
        {!! (!empty( $arrShowFieldFrom['categories_desc'] ))?
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('categories_desc', __("item_category.label_categories_desc").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.               
                Form::textarea('categories_desc', @$item_category['categories_desc'], array('rows'=> config("core.layout.input.textarea.rows"),'placeholder'=>__("item_category.placeholder_categories_desc"),'class' => 'form-control text-editor','','', 'data-parsley-error-message' =>  __("validation.required", ['attribute' => __("item_category.label_categories_desc")]) ))
                .'</div>
            </div>'
        : '' !!}
        ...
        {!! (!empty( $arrShowFieldFrom['active'] ))?
            '<div class="'.config('core.layout.form.add.box').'">'.
                Form::label('active', __("item_category.label_active").' ', array('class' => config("core.layout.form.add.label")))
                .'<div class="'.config('core.layout.form.add.input').'">'.             
