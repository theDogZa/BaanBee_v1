    ...
    {!! Form::open(['url' => Request::path(),'method'=>'GET','class'=>'form-label-left input_mask form-process','id'=>'from-advanced-search']) !!}
        ...
        {!! (!empty( $arrShowField['item_type_id'] ))?       
            '<div class="'.config('core.layout.form.search.box').'">'.       
                Form::label('item_type_id', __('item_category.th_item_type_id'), array('class' => config("core.layout.form.search.label")))
        ...
        {!! (!empty( $arrShowField['categories_name'] ))?       
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('categories_name', __('item_category.th_categories_name'), array('class' => config("core.layout.form.search.label")))
                .'<div class="'.config('core.layout.form.search.input').'">'.
        ...
        {!! (!empty( $arrShowField['categories_code'] ))?       
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('categories_code', __('item_category.th_categories_code'), array('class' => config("core.layout.form.search.label")))
                .'<div class="'.config('core.layout.form.search.input').'">'.
        ...
        {!! (!empty( $arrShowField['categories_desc'] ))?
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('categories_desc', __('item_category.th_categories_desc'), array('class' => config("core.layout.form.search.label")))
                .'<div class="'.config('core.layout.form.search.input').'">'.
        ...
        {!! (!empty( $arrShowField['active'] ))?
            '<div class="'.config('core.layout.form.search.box').'">'.
                Form::label('active', __('item_category.th_active'), array('class' => config("core.layout.form.search.label")))
                .'<div class="'.config('core.layout.form.search.input').'">'.
