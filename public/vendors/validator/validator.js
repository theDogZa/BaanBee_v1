...
var validator = (function($){
    var message, tests, checkField, validate, mark, unmark, field, minmax, defaults,
        validateWords, lengthRange, lengthLimit, pattern, alertTxt, data, errortext, /*checkAlert,*/
        email_illegalChars = /[\(\)\<\>\,\;\:\\\/\"\[\]]/,
    ...
    */
    message = {
		...
		dbduplicate     : 'data duplicate on database'
    };
    ...
    */
    function checkField(){
        ...
        */
		emptyMessage  = data['validateEmptyMessage'];
		dbduplicate = data['validateDbDuplicate'];
		...
		// check Message empty for field
		if(emptyMessage) alertTxt = emptyMessage;
