...
class Item_adjustedsController extends Controller
{
	...
	public function create(Request $request)
	{
		...
		$_cItems = App::make('\App\Http\Controllers\ItemsController');
		$Items = $_cItems->__select_items();
		$compact['Items'] = $Items;


		// //---------------------------------------

		// //$zCostcenters = DB::table('z_costcenter')->Where('id',7)->orderBy('id')->get();
		// $zCostcenters = DB::table('z_costcenter')->orderBy('id')->get();
		...
		// 				$commbin =  $ZCC->code.".". $ZACC->code.".". $ZPC->code . "." . $ZCUS->code;
		// 				$commbinTXT .= $commbin . PHP_EOL;
		...
		// 		}
		// 	}
		// 	Storage::put($ZCC->code . '.csv', $commbinTXT);
		// }
